...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// Create a thread with a lambda (introduce in Java 8 for code readability)
...
// 1st way to creawte a thread is to create a class that implements Runnable Interface
