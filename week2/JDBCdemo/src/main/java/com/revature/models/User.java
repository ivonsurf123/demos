...
public class User implements Serializable{
	...
	// This allows me to create a User from within my "business layer" a.k.a Java application
	// A user will have an ID generated for it once it gets persisted to the DB
